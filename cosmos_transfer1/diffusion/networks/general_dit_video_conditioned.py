...
from cosmos_transfer1.diffusion.module.blocks import TimestepEmbedding, Timesteps
        ...
        **kwargs,
        ...
        if data_type == DataType.VIDEO:
            ...
            if parallel_state.is_initialized():
                ...
                condition_video_input_mask = split_inputs_cp(condition_video_input_mask, seq_dim=2, cp_group=cp_group)
